    ...
    return (
      <div className="homepage-container">
        ...
        <div className="homepage-group homepage-group--4">
          ...
          <div className="homepage-group--4__description">
            I like to use Single Page Apps for the client and a NodeJs API
            server for the server-side, NoSQL as database, hosting it on AWS
        ...
        <div className="homepage-group homepage-group--5">
          <Footer />
        </div>
      </div>
    );
