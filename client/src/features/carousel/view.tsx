...
export const CarouselContent = ({
  ...
  return (
    <div className="carousel-wrapper">
      <div
        onClick={() => handleMoveCarousel(0)}
        className="carousel-item-cell-arrow carousel-item-cell-arrow--left"
      >
        {'<'}
      </div>
              ...
              <div
                className={
                  (index + 1) % ITEMS_PER_ROW === 0
                    ? 'carousel-item-cell--box carousel-item-cell--box--no-gap'
                    : 'carousel-item-cell--box'
                }
                key={index}
      ...
      <div
        ...
        className="carousel-item-cell-arrow carousel-item-cell-arrow--right"
      >
        {'>'}
      </div>
    </div>
